...
const fetchNewContributors = async (now: number) => {
  ...
  try {
    ...
    const contributorsArray: Contributor[] = Array.from(
      contributionsMap.values()
    )
      .filter(
    ...
    <div class="homepage-content-container">
      <main class="homepage-main-content">
        ...
        <div class="section vp-doc flex flex-col items-center mt-10">
          <h2 id="meet-the-team" class="section-title op70 font-normal">
            Meet The Team
          </h2>
        ...
        <div
          v-if="!fetchError"
          class="section vp-doc flex flex-col items-center mt-10"
        >
          <h2
